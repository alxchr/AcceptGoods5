...
public class WebserviceHTTPClient extends OkHttpClient {
    ...
    public WebserviceHTTPClient(String url) {
        try {
            ...
            InputStream clientCertificateContent = App.get().getResources().openRawResource(R.raw.terminal);
            keyStore.load(clientCertificateContent, "".toCharArray());
            KeyManagerFactory keyManagerFactory = KeyManagerFactory.getInstance(KeyManagerFactory.getDefaultAlgorithm());
            keyManagerFactory.init(keyStore, "".toCharArray());
            InputStream myTrustedCAFileContent = App.get().getResources().openRawResource(R.raw.chaincert);
