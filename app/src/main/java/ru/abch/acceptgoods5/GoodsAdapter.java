...
//    ArrayList<GoodsRow> goodsList;
    ...
    public GoodsAdapter(Context context, ArrayList<GoodsPosition> goods) {
        ctx = context;
        goodsList = goods;
    ...
    public void update(ArrayList<GoodsPosition> goodsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GoodsPosition gp = (GoodsPosition) getItem(position);
        String goods = gp.article + " " + gp.description;
...
//        ((TextView) view.findViewById(R.id.tv_goods_brand)).setText(gr.brand);
        ((TextView) view.findViewById(R.id.tv_goods_qnt)).setText(String.valueOf(gp.qnt));
        ((TextView) view.findViewById(R.id.tv_goods_cell)).setText(Config.formatCell(gp.cell));
