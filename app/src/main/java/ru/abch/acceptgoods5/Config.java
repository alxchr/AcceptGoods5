...
public class Config {
    public static String ip = "tomcat2.comtt.ru";
    public static final String ipComtt = "tomcat2.comtt.ru";
...
*/
    ...
    public static final String barcodesPath = "/accept5/barcodes/";
    ...
    public static final String packagesPath = "/move3/packages/";
    ...
    public static final String pricePath = "/move3/goods/price/";
